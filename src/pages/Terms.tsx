      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="mb-4">By accessing or using the smallCapSIGNAL™ website or any related services (the “Site”), you agree to be legally bound by these Terms of Use, our Privacy Policy, and any additional rules, policies, or guidelines that may be posted from time to time (collectively, the “Agreement”). If you do not agree to all terms of the Agreement, you are not permitted to use the Site or any smallCapSIGNAL™ offerings.
smallCapSIGNAL™ is owned and operated by Renn Valo. All content provided through the Site—including but not limited to emails, videos, blog posts, commentary, third-party links, newsletters, reports, tools, and social media communications (collectively, the “Content”)—is intended solely for informational and entertainment purposes. smallCapSIGNAL™ is not a registered investment advisor, broker-dealer, or financial planner, and no Content should be interpreted as personalized investment advice, a recommendation, or a solicitation to buy, sell, or hold any securities.
...
•	smallCapSIGNAL™ disclaims all warranties (express or implied), including but not limited to accuracy, completeness, reliability, or fitness for a particular purpose.
•	smallCapSIGNAL™ is not liable for any loss or damage resulting from reliance on any Content or use of the Site.
...
We reserve the right to modify or update the Agreement at any time without specific notice. Any such changes will be effective upon posting. Your continued use of the Site following the posting of revised terms constitutes your acceptance of those changes.
            ...
            <p className="mb-4">
              In no event shall smallCapSIGNAL be liable for any damages arising out of the use or inability to use the 
